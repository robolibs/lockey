...
namespace lockey::cert {
    ...
    class CertificateBuilder {
      public:
        ...
        CertificateResult<Certificate> build(const crypto::Lockey::KeyPair &issuer_key, bool self_signed = false) const;
        CertificateResult<Certificate> build_ed25519(const crypto::Lockey::KeyPair &issuer_key,
