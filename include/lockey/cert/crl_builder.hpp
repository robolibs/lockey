...
class CrlBuilder {
  public:
    ...
    CertificateResult<Crl> build_ed25519(const crypto::Lockey::KeyPair &issuer_key) const;

  private:
    CertificateResult<Crl> build(const crypto::Lockey::KeyPair &issuer_key) const;
