...
std::vector<uint8_t> encode_time_string(std::string_view str, ASN1Tag tag) {
...
std::vector<uint8_t> encode_utf8_string(std::string_view str) {
    return encode_string(str, ASN1Tag::UTF8String);
}
...
std::vector<uint8_t> encode_ia5_string(std::string_view str) {
    return encode_string(str, ASN1Tag::IA5String);
}

std::vector<uint8_t> encode_utctime(const std::string &view) {
    return encode_time_string(view, ASN1Tag::UTCTime);
}
