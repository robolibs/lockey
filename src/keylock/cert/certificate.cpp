...
namespace keylock::cert {
    ...
    CertificateSignatureResult Certificate::sign(const crypto::Context::KeyPair &issuer_key, hash::Algorithm) const {
    ...
    std::vector<uint8_t> Certificate::fingerprint(::keylock::hash::Algorithm algo) const {
