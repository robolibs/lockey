...
namespace keylock::cert {
    ...
    CertificateResult<Crl> CrlBuilder::build(const crypto::Context::KeyPair &issuer_key) const {
    ...
    CertificateResult<Crl> CrlBuilder::build_ed25519(const crypto::Context::KeyPair &issuer_key) const {
