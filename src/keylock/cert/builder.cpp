...
namespace keylock::cert {
    ...
    CertificateResult<Certificate> CertificateBuilder::build(const crypto::Context::KeyPair &issuer_key,
    ...
    CertificateResult<Certificate> CertificateBuilder::build_ed25519(const crypto::Context::KeyPair &issuer_key,
                                                                     bool self_signed) const {
